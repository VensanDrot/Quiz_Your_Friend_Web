        ...
        if(isset($_POST["New_Quiz"])){ 
            ...
            if (!empty($last_img) && !empty($last_name) && !empty($last_nques) && !empty($last_quiz_name) && (!empty($radio) || $radio == '0')){
                ...
                $table = mysqli_query($connect,"CREATE TABLE $tname (
                   ...
                   echo "<script>window.location.href='adminpanel.php?Part=Quiz';</script>";
                }  
            }
    ...
    <div class="container">
     ...
     <!-- Start of the Quiz part-->               
        ...
        <div class="">
            ...
            <input class="form-control" required="" placeholder="Enter the label on the quiz" maxlength="255" name="Name" id="Name" type="text" value="<?=$last_name?>" style="margin-bottom: 1rem;">
            <?=(isset($error_quiz_name))?"<p style='color:red; font-size:23px;'>$error_quiz_name</p>":""; ?>
            <input class="form-control" required="" placeholder="Enter the Quiz authentication name" maxlength="255" name="quiz_name" type="text" value="<?=$last_quiz_name?>" style="margin-bottom: 1rem;">
            <?=(isset($error_nques))?"<p style='color:red; font-size:23px;'>$error_nques</p>":""; ?>
            <input class="form-control"  placeholder="Number of questions" maxlength="255" name="nquestion" id="nquestion" type="number" value="<?=$last_nques?>" style="margin-bottom: 1rem;" min="1"; >
            <div >
